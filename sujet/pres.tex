...
\vfill
	{\Large
\begin{center}
	Plongement des surfaces de Jacobi-Maupertuis
\end{center}
	}
...
leo.nicollier@ens-paris-saclay.fr
\end{frame}
...
\begin{columns}
	\begin{column}{0.45\textwidth}
		...
		\includegraphics[width=\linewidth]{f/geocyl2.png}
	\end{column}
	\begin{column}{0.55\textwidth}
		...
		\hfill\includegraphics[width=0.8\linewidth]{f/keplers.jpg}
	\end{column}
\end{columns}
...
{\bf Objectif:} Construire des surfaces de révolution de Jacobi-Maupertuis pour
les potentiels de la forme~$\color{blue}V(q)=\|q\|^\alpha$

{\bf Cas particuliers:} Newton, Hooke, Schwarzschild (approché), orbites logarithmiques, etc.
...
\tiny
		\includegraphics[width=0.2\linewidth]{f/analplug.png}
		\color{gray}
		{\bf R.Moeckel}, \emph{Embedding the Kepler problem as a surface of
		revolution}, 2018
%	\end{column}
%	\begin{column}{0.45\textwidth}
%	\end{column}
